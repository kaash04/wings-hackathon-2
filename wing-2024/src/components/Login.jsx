    ...
    <>
      <div className='Login'>
        <div className='upperButton'>
          ...
          <HashLink to='/register'><Button variant='outlined' sx={{ width: '50%', borderRadius: 0, height: '5rem', fontSize: '1.5rem', borderTop: 'none', borderRight: 'none', borderColor: 'rgba(127, 121, 121, 0.5)' }}>Register</Button></HashLink>
        </div>
